 ...
 * 1. __init: Marks the function for the initialization phase. Memory is freed after boot/load.
 * 2. __exit: Marks the function for cleanup. Discarded if the module is built-in.
 ...
 * - MODULE_IMPORT_NS: Import specific symbol namespaces (required for some 5.4+ APIs)
